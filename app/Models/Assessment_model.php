...
class Assessment_model extends Model
{
    ...
    public function tampildataform1()
    {
        ...
        // $sql = "SELECT * FROM assessment_info WHERE form='F1'";

        $sql = "SELECT pasien.DATE_OF_BIRTH, assessment_info.BODY_ID,  assessment_info.NO_REGISTRATION, assessment_info.THENAME, assessment_info.THEADDRESS, assessment_info.GENDER, assessment_info.AGEYEAR, assessment_info.AGEMONTH, assessment_info.AGEDAY, assessment_info.CLASS_ROOM_ID, assessment_info.EXAMINATION_DATE
       FROM pasien
    ...
    public function tampildataform4()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, assessment_info.BODY_ID,  assessment_info.NO_REGISTRATION, assessment_info.THENAME,  assessment_info.GENDER, assessment_info.CLASS_ROOM_ID, assessment_info.ALLOANAMNESIS_CONTACT
       FROM pasien
       INNER JOIN assessment_info
       ON pasien.NO_REGISTRATION = assessment_info.NO_REGISTRATION
    ...
    public function tampildataform6()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, pasien.THENIK, assessment_info.BODY_ID,  assessment_info.NO_REGISTRATION, assessment_info.THENAME 
       FROM pasien
       INNER JOIN assessment_info
       ON pasien.NO_REGISTRATION = assessment_info.NO_REGISTRATION
