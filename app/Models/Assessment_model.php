...
class Assessment_model extends Model
{
    ...
    //menampilkan semua data pasien (digunakan saat ingin mengisi formuir baru)
    ...
    //menampilkan data pada tabel di setiap formulir 
    ...
    public function tampildataform1()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, assessment_info.BODY_ID, assessment_info.no,  assessment_info.NO_REGISTRATION, assessment_info.THENAME, assessment_info.THEADDRESS, assessment_info.GENDER, assessment_info.AGEYEAR, assessment_info.AGEMONTH, assessment_info.AGEDAY, assessment_info.CLASS_ROOM_ID, assessment_info.EXAMINATION_DATE
       FROM pasien
    ...
    public function tampildataform4()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, assessment_info.BODY_ID, assessment_info.no,  assessment_info.NO_REGISTRATION, assessment_info.THENAME,  assessment_info.GENDER, assessment_info.CLASS_ROOM_ID, assessment_info.ALLOANAMNESIS_CONTACT
       FROM pasien
       INNER JOIN assessment_info
       ON pasien.NO_REGISTRATION = assessment_info.NO_REGISTRATION
    ...
    public function tampildataform5()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, assessment_info.BODY_ID, assessment_info.no,  assessment_info.NO_REGISTRATION, assessment_info.THENAME, assessment_info.THEADDRESS, assessment_info.GENDER,  assessment_info.CLINIC_ID, assessment_info.EXAMINATION_DATE, assessment_info.ANAMNASE, pasien.FATHER, pasien.MOTHER, pasien.CONCLUSION, pasien.PPKRUJUKAN
       FROM pasien
       INNER JOIN assessment_info
       ON pasien.NO_REGISTRATION = assessment_info.NO_REGISTRATION
    ...
    public function tampildataform6()
    {
        ...
        $sql = "SELECT pasien.DATE_OF_BIRTH, pasien.THENIK, assessment_info.BODY_ID, assessment_info.no,  assessment_info.NO_REGISTRATION, assessment_info.THENAME 
       FROM pasien
       INNER JOIN assessment_info
       ON pasien.NO_REGISTRATION = assessment_info.NO_REGISTRATION
    ...
    public function tampildataform7()
    {
    ...
    //menampilkan form dengan id tertentu dari tabel pasien ketika pertama kali mengisi form
    ...
    //menambahkan data ketika mengisi formulir
    ...
    public function tambahdata()
    {
        ...
        $ttd_4 = $this->request->getPost('ttd_4');
        $ttd_5 = $this->request->getPost('ttd_5');
    ...
    //menghapus formulir pada setiap tabel berdasarkan nomor registrasi dan no (primary key)

    public function deleteform($no)
    {

        $sql = "DELETE FROM assessment_info WHERE no='$no'";
    ...
    public function editform()
    {
        ...
        $sql = "UPDATE assessment_info SET  form = '$form',
                                            body_id = '$body_id',
                                            ...
                                            alloanamnesis_result = '$alloanamnesis_result', 
                                            ...
                                            ttd_5 = '$ttd_5', 
                                            lokalis = '$lokalis', 
                                            alloanamnesis_address = '$alloanamnesis_address', 
                                            alloanamnesis_sex = '$alloanamnesis_sex', 
                                            alloanamnesis_age = '$alloanamnesis_age', 
