...
<head>
    ...
    <title>ASESMEN AWAL MEDIS PASIEN BEDAH ORTHOPEDI RAWAT JALAN</title>
        ...
        <form action="<?= site_url('#') ?>" method="post" autocomplete="off">
            ...
            <table class="table table-bordered mb-2" style="border: 2px solid black">
                ...
                <tr style="border: 2px solid black">
                    <td colspan="2">
                        <h5 class="text-center">ASESMEN AWAL MEDIS PASIEN BEDAH ORTHOPEDI RAWAT JALAN</h5>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        ...
                        <div class="container">
                            <ul>
                                ...
                                <li>
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            <label>Hasil Alloanamnesis</label>
                                        </div>
                                        <div class="col-md-9">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-2">
                                    <strong><label class="col-form-label">A. KEADAAN UMUM</label></strong>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="container">
                                ...
                                <br>
                                <strong><label class="col-form-label">B. STATUS LOKALIS</label></strong>
                                <br>
                                <div class="col-md-12 text-center align-items-center">
                                    <div class="container" style="border:1px solid black">
                                        <img class="mt-3" src="<?= base_url('assets/ortho.png') ?>" width="900px">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <strong><label>Diagnosis Banding</label></strong>
                            </div>
                            <div class="col-md-10">
                ...
                <tr>
                    <td colspan="2">
                        <h6>TERAPI/INSTRUKSI (Stading Order)</h6>
                        <textarea class="form-control" name="v_18" id="v_18" cols="6" rows="7"></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="15%">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="date" name="v_27" id="v_27">
                                    </div>
                                </div>
                            </div>
                        </div>
