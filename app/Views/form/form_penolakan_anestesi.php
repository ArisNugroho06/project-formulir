    ...
    <tr>
      <td>
        <p>
          ...
          alamat <input type="text" name="v_13" id="v_13"> dengan ini menyatakan <strong>PENOLAKAN</strong> untuk dilakukannya tindakan <input type="text" name="v_14" id="v_14"> terhadap
