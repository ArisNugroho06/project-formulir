    ...
    <tr>
      <td>
        <p>
          ...
          alamat <input type="text" name="v_21" id="v_21"> dengan ini menyatakan <strong>PERSETUJUAN</strong> untuk dilakukannya tindakan <input type="text" name="v_22" id="v_22"> terhadap
