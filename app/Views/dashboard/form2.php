...
<body>
    ...
    <h3 class="text-center text-uppercase mt-5">Formulir Persetujuan Tindakan Anestesi Lokal</h3>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="<?= site_url('delete/form2/' . $row['no']) ?>" class="btn btn-danger"><i class="bi bi-trash-fill text-light"></i></a>
                        </td>
                        </td>
                    </tr>
                </tbody>
