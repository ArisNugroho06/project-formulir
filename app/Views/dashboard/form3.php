...
<body>
    ...
    <h3 class="text-center text-uppercase mt-5">Formulir Penolakan Tindakan Anestesi Lokal</h3>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <a href="<?= site_url('aksi/updateform3/' . $row->BODY_ID) ?>" class="btn btn-warning">Update</a>
                                </div>
                                <div class="col-md-6">
                                    <a href="<?= site_url('aksi/deleteform3/' . $row->BODY_ID) ?>" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
